...
/*
        ...
        products = System.getProperty("products", parg).split(",");
        iterations = Integer.valueOf(System.getProperty("iterations", iarg));
        threads = Integer.valueOf(System.getProperty("iterations", targ));
